...
ui-options-hrtf = Включить HRTF для позиционного звука
ui-options-hrtf-description = Имитирует объёмное направление звука в наушниках. Применяется после перезапуска клиента.
