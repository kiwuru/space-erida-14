...
tts-voice-name-anastasia = Анастасия
tts-voice-name-petr = Пётр
tts-voice-name-valeria = Валерия
...
tts-voice-name-wizard = Волшебница
...
tts-voice-name-ladyvashj-alt = Леди Вайш (Альтернативный) (Warcraft 3)
