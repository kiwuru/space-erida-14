...
ent-ActionGravityJump = Прыжок
    .desc = Активировав продвинутую двигательную систему, вы переместитесь на короткое расстояние в направлении взгляда.
ent-ActionVulpkaninGravityJump = Прыгнуть
    .desc = Используйте ловкие ноги, чтобы прыгнуть на небольшое расстояние. Постарайтесь ни во что не врезаться!
