...
public sealed class BlobFactorySystem : EntitySystem
{
    ...
    private static readonly ProtoId<ReagentPrototype> Phlogiston = new ProtoId<ReagentPrototype>("Phlogiston");
    private static readonly ProtoId<ReagentPrototype> TearGas = new ProtoId<ReagentPrototype>("TearGas");
    private static readonly ProtoId<ReagentPrototype> Lexorin = new ProtoId<ReagentPrototype>("Lexorin");
    private static readonly ProtoId<ReagentPrototype> Mold = new ProtoId<ReagentPrototype>("Mold");
    private static readonly ProtoId<ReagentPrototype> Bicaridine = new ProtoId<ReagentPrototype>("Bicaridine");
    private static readonly ProtoId<ReagentPrototype> Aluminium = new ProtoId<ReagentPrototype>("Aluminium");
    private static readonly ProtoId<ReagentPrototype> Iron = new ProtoId<ReagentPrototype>("Iron");
    private static readonly ProtoId<ReagentPrototype> Uranium = new ProtoId<ReagentPrototype>("Uranium");
