...
public sealed class BlobObserverSystem : SharedBlobObserverSystem
{
    ...
    private static readonly EntProtoId BlobCaptureObjective = new EntProtoId("BlobCaptureObjective");
    private static readonly EntProtoId MobObserverBlobController = new EntProtoId("MobObserverBlobController");
