...
public sealed class BlobCarrierSystem : SharedBlobCarrierSystem
{
    ...
    private static readonly EntProtoId ActionTransformToBlob = new EntProtoId("ActionTransformToBlob");

    private static readonly ProtoId<LanguagePrototype> BlobLang = new ProtoId<LanguagePrototype>("Blob");
